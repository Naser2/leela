...
export default function AboutPage() {
  return (
    <>
      <div class="hero-content -mt-10 bg-gray-50 lg:pt-24 ">
        <div class="mx-auto max-w-3xl text-center">
          {/* <h2 class="text-base font-semibold leading-7 text-blue-400 ">About</h2> */}
        </div>
          ...
          <div className="grid grid-cols-1 px-2 lg:grid-cols-2 min-[1399px]:grid-cols-1  ">
            ...
            <div className="animate-fadeIn team-member-details px-6 pt-6 pb-0  md:py-6 lg:pl-10 xl:mr-24 min-[1400px]:px-14 min-[1600px]:pl-14">
              <h1 class="member-name bg-gray-50/30 pb-2  md:pb-2 ">
                ...
                <div className=" my-2: max-w-7xl px-2">
                ...
                <FadeInSection>
                  <p className="animate-fadeIn paragraph   px-2  pt-0  pb-4  lg:text-2xl ">
                    <span style={{ fontWeight: '400' }}>
                      ...
                      collaborates with WHTWRKS clients to define long-term
                      visions, goals and strategies. Additionally, Soma provides
                      strategic guidance and tactical services to our team while
                      creating marketing plans designed to help acquire and
      ...
      <div className="md:flex-block bg-gray-50/10 px-6 md:px-14 md:pt-10  lg:px-20  xl:pr-36 min-[1620px]:hidden ">
        ...
        <p className="animate-fadeIn paragraph px-2   pt-0  pb-4  lg:text-2xl xl:mb-44 ">
          <span style={{ fontWeight: '400' }}>
            ...
            brands in fashion, beauty &amp; consumer packaged goods. She
            collaborates with WHTWRKS clients to define long-term visions, goals
            and strategies. Additionally, Soma provides strategic guidance and
            tactical services to our team while creating marketing plans
            designed to help acquire and retain customers for each client.
          </span>
        </p>{' '}
      </div>
    </>
