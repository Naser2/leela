              ...
              <div className="grid grid-cols-1 px-2 lg:grid-cols-2 min-[1399px]:grid-cols-1  ">
                ...
                <div className="animate-fadeIn team-member-details -mt-3 mb-4 px-6 pb-0 md:py-6  lg:pt-6 lg:pl-10 xl:mr-24 min-[1400px]:px-14 min-[1600px]:pl-14">
                  <h1 class="member-name bg-gray-50/30 pb-2  md:pb-2 ">
                    ...
                    <div class="lg:-mt-10px group relative mt-[1.23rem] mt-2 flex flex-none flex-col items-start border-transparent pb-2 text-left hover:border-t-2 md:pb-0 lg:w-[25vw] lg:border-t lg:border-sky-400 lg:hover:border-sky-400 ">
                      <div className="mt-4 flex inline-flex">
                        <h2 class="member-jobtitle -mt-2 px-2 py-1.5  text-2xl text-blue-500  md:order-first  md:bg-sky-50/5 md:px-0  md:px-2  ">
                          LEELA&apos;s FOUNDER
                        </h2>{' '}
                        <svg
                      ...
                      <p className="mt-0 mb-4 bg-sky-50/30 px-2  text-sm font-semibold leading-6 text-slate-800/80 text-slate-700 md:block lg:mt-2 lg:text-lg">
                        <h2 class="text-2 font_5 color_15 -mt-2 py-1.5  text-2xl text-slate-600 md:order-first  md:bg-sky-50/50 md:px-2 md:px-3 lg:-mt-0 lg:-ml-4  lg:bg-sky-200/10 ">
          ...
          <div className="grid grid-cols-1 px-2 lg:grid-cols-2 min-[1399px]:grid-cols-1  ">
            <div className="animate-fadeIn team-member-details -mt-3 mb-4 px-6 pb-0 md:py-6  lg:pt-6 lg:pl-10 xl:mr-24 min-[1400px]:px-14 min-[1600px]:pl-14">
              <div className="xxl:contents hidden  bg-gray-50/20 ">
                <div class="group relative -mt-px flex flex-none flex-col items-start   bg-gray-100/60 px-2 pt-4  text-left md:-ml-4 md:w-[35vw] md:px-4 md:pb-6 md:pt-4 lg:w-auto">
