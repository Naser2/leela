...
export function Logo(props) {
  return (
    <div className="w-[200px] lg:w-[30%]">
      <div className="mt-26 h-[41.5000000pt] w-[267.000000pt] lg:mt-10 lg:h-[83.000000pt]">
        <h1 className="!text-6xl font-bold">LEELA</h1>
      </div>
      {/* <svg
        version="1.0"
      ...
      >
        ...
        >
          <path
            d="M4744 744 c-10 -16 -41 -59 -69 -96 -27 -37 -74 -100 -104 -140 -29
          ...
          />
          <path
            d="M90 405 l0 -335 245 0 245 0 0 45 0 45 -205 0 -205 0 0 290 0 290
          -40 0 -40 0 0 -335z"
          />
          <path
            d="M1100 405 l0 -335 300 0 300 0 0 45 0 45 -260 0 -260 0 0 100 0 100
              260 0 260 0 0 45 0 45 -260 0 -260 0 0 105 0 105 260 0 260 0 0 40 0 40 -300
            0 -300 0 0 -335z"
          />
          <path
            d="M2210 405 l0 -335 305 0 305 0 0 45 0 45 -260 0 -260 0 0 100 0 100
            260 0 260 0 0 45 0 45 -260 0 -260 0 0 105 0 105 260 0 260 0 0 40 0 40 -305
            0 -305 0 0 -335z"
          />
          <path
            d="M3340 405 l0 -335 245 0 245 0 0 45 0 45 -205 0 -205 0 0 290 0 290
          -40 0 -40 0 0 -335z"
          />
        </g>
      </svg> */}
      <h1
        className="color_15 !-mt-0 lg:!-mt-14"
        style={{ lineHeight: '1.05em' }}
      >
        <span className="color_15">CONSULTANCY </span>
      </h1>
      {/* <img
        className="max-[700px]-mt-10px z-10 h-full min-h-[19px] w-full pt-2"
        src={'/consulting.png'}
        alt=""
        fetchpriority="high"
      /> */}
