...
export const SectionHero = () => {
  return (
    <section id="comp-jwuch32x" className=" -mt-20 lg:mt-24 ">
      <div
        ...
        >
          ...
          <div className="mx-6 lg:mx-0">
            <div>
              <div
                id="SITE-TITLE"
                className="mt-4 max-[600px]:inline-flex  lg:mt-10  lg:-mt-0 "
              >
                ...
                <div className="mt-1 pl-3  lg:mt-10 lg:px-0">
                  <h1 className="lg:font_4">
                    <span style={{ fontSize: '72px', lineHeight: '1.05em' }}>
                      <span className="md:px-0 lg:px-2">
                        <span className="color_15  site-title">LEELA</span>
                      </span>
                    </span>
                  </h1>
                  <p className="text-2 font_5 px-2 md:px-2 lg:-mt-0 ">
                    <span
                      style={{
              ...
              <div className="items-center justify-center gap-y-2 gap-x-4 md:grid md:grid-cols-10 lg:gap-x-8 xl:gap-x-20">
                ...
                <div class="col-span-4 col-start-1 w-full max-w-2xl items-center justify-center lg:mt-14 lg:pb-14  xl:-mb-8 xl:flex-none">
                  <div class="hidden h-full  md:-mx-8 lg:flex xl:mx-0 xl:aspect-auto">
                    <img
                      className="h-full flex-auto rounded-t-2xl bg-white"
                      src={`${featuredProject.src}`}
                      alt=""
                    />
                  </div>
